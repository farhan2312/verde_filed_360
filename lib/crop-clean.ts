...
const CROP_CLEAN_RULES: [RegExp, string][] = [
  ...
  [/GILOD|GILOR|TINDORA|TENDLI|IVY ?GOURD/, "ivy_gourd"],
  ...
  [/TOBACCO|TABB?ACC?O|TABACCO|TAMBAKU|TAMAKU/, "tobacco"],
  [/BETEL|\bPAAN\b/, "betel"],
  [/GINGER|ADRAK/, "ginger"],
  [/FENNEL|SAUNF/, "fennel"],
