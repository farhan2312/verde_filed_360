...
export const VISIT_TYPE_COLORS: Record<string, string> = {
  "Crop inspection": "#678722",
  "Crop monitoring": "#678722",
  "Product demo": "#1565C0",
...
export const VISIT_RECOMMENDATIONS: Record<string, RecCard[]> = {
  "Crop inspection": [
    { c: "#678722", t: "Schedule follow-up spray advisory if pest activity confirmed. Coordinate with store for pesticide inventory." },
  ...
  "Crop monitoring": [
    { c: "#678722", t: "Document crop growth stage and compare against expected calendar for the variety." },
  ...
  "Product demo": [
    { c: "#678722", t: "Log farmer feedback and interest level. Raise a lead if purchase intent is high." },
  ...
  "Product delivery": [
    { c: "#678722", t: "Confirm product receipt and application plan with the farmer. Note any usage queries." },
  ...
  "Follow-up": [
    ...
    { c: "#678722", t: "Confirm next visit date and specific objective before leaving the field." },
  ],
  "First visit": [
    { c: "#678722", t: "Complete full farmer profile registration. Capture land, crop, soil, and commercial data." },
  ...
  "Sowing advisory": [
    { c: "#678722", t: "Confirm seed variety recommended matches soil type and season. Document in farmer notes." },
  ...
  "Harvest planning": [
    ...
    { c: "#678722", t: "Discuss next season crop plan and pre-book inputs. Create advance order from store." },
  ...
  "Re-engagement": [
    ...
    { c: "#678722", t: "Offer loyalty benefit or personalised input recommendation to rebuild trust." },
  ...
  "Season review": [
    ...
    { c: "#678722", t: "Plan next-season input requirement and create advance order. Lock pricing where possible." },
  ...
  "Soil advisory": [
    ...
    { c: "#678722", t: "Coordinate organic/bio compost availability from store. Offer application demo if needed." },
  ...
  "Pest check": [
    ...
    { c: "#678722", t: "Re-visit within 7 days to assess treatment efficacy and prevent crop loss escalation." },
  ],
};

export const DEFAULT_RECOMMENDATIONS: RecCard[] = [
  { c: "#678722", t: "Schedule a follow-up visit within 14 days to assess outcomes from this visit." },
